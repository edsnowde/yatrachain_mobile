...
class LightModeColors {
  static const lightPrimary = Color(0xFF1A73E8); // Deep Blue
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE3F2FD);
  static const lightOnPrimaryContainer = Color(0xFF0D47A1);
  static const lightSecondary = Color(0xFF2E7D32); // Kerala Green
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFF43A047);
...
class DarkModeColors {
  ...
  static const darkSecondary = Color(0xFF81C784); // Light Kerala Green
